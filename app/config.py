...
class Settings(BaseSettings):
    ...
    pro_daily_credits: int = Field(default=500, alias="PRO_DAILY_CREDITS")
    pro_monthly_credits: int = Field(default=10000, alias="PRO_MONTHLY_CREDITS")
    business_daily_credits: int = Field(default=3000, alias="BUSINESS_DAILY_CREDITS")
    business_monthly_credits: int = Field(default=60000, alias="BUSINESS_MONTHLY_CREDITS")
    ...
    pro_daily_limit: int = Field(default=500, alias="PRO_DAILY_LIMIT")
    business_daily_limit: int = Field(default=3000, alias="BUSINESS_DAILY_LIMIT")
