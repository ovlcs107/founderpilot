...
class Settings(BaseSettings):
    ...
    pro_price_ton: str = Field(default="11", alias="PRO_PRICE_TON")
    business_price_ton: str = Field(default="35", alias="BUSINESS_PRICE_TON")
    go_price_btc: str = Field(default="0.00004", alias="GO_PRICE_BTC")
    plus_price_btc: str = Field(default="0.00009", alias="PLUS_PRICE_BTC")
    pro_price_btc: str = Field(default="0.00022", alias="PRO_PRICE_BTC")
    business_price_btc: str = Field(default="0.00070", alias="BUSINESS_PRICE_BTC")
